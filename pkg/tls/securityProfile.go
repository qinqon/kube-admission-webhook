...
func SecurityProfileSpec(profile *TLSSecurityProfile) ([]string, TLSProtocolVersion) {
	if profile == nil {
		return []string{}, ""
	}
	...
	return TLSProfiles[profile.Type].Ciphers, TLSProfiles[profile.Type].MinTLSVersion
}
